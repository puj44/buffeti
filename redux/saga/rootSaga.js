...
import { handleGetCustomerDetails, handleSendOtpEmail, handleUpdateProfile, handleVerifyEmail } from "../handlers/customerHandler";
...
export function* watcherSaga() {
    try{
        ...
        yield all([
            ...
            yield takeLatest('customer/updateProfileAction', handleUpdateProfile),
            yield takeLatest('customer/sendEmailOtp', handleSendOtpEmail),
            yield takeLatest('customer/verifyEmailOtp', handleVerifyEmail),
