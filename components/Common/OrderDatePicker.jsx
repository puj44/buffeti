    ...
    days: {
      ...
      items: {
        ...
        item: {
          ...
          selected:
            "bg-[#B42318] rounded-[25px] text-color-white hover:bg-[#B42318]",
          disabled: "text-gray-400  rounded-[25px]",
        },
      },
    },
    months: {
...
function OrderDatePicker({ handleChangeDate, value }) {
    ...
    <div className="border-[1px] border-[#E3E5E5] rounded-lg flex   py-2 px-2 md:px-4">
      {
        <Dropdown
          ...
          label=""
          renderTrigger={() => (
            <div className="flex flex-row gap-3 overflow-hidden w-full justify-start items-center cursor-pointer">
              <Image
                ...
                alt=""
              />
              <div className="">{formatDate(value ?? new Date())}</div>
            </div>
          )}
        ...
        >
          <Dropdown.Item as="div">
            <Datepicker
              ...
              // value={new Date(value ?? nextDate).getDate()}
              ...
              defaultDate={new Date(value ?? nextDate)}
              inline
            />
          </Dropdown.Item>
        </Dropdown>
