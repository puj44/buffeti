            ...
            case "login":
                return(
                    <>
                        ...
                        <button className={`btn primary-btn ${isLoading ? "opacity-60":""}`} onClick={()=>{sendOTP()}}>
                            {
                                isLoading?
                ...
                return(
                    <>
                        <div className='flex flex-col gap-2'>
                            ...
                            { error && <span className='text-color-secondary-red small-title' id="register-error">{error}</span>}
                        </div>
            ...
            case "otp_verification":
                return(
                    <>
                     ...
                     <button className={`btn primary-btn ${isLoading ? "opacity-60":""}`} onClick={()=>{verifyOtp()}}>
                            {
                                isLoading?
                                <span className='loader'></span>
                                :
                     ...
                     <div className='flex flex-row justify-between gap-1 '>
                            <p>{"Didn't receive code? "}&nbsp;<span className={`${timer === 0 ?"text-color-primary cursor-pointer" :""} font-medium`} onClick={()=>{resendOTP()}}>{" Resend Code"}</span></p>
                            {timer > 0 && <p className='text-color-secondary-gray'>
                                {
                                    timer >= 60 ?
