...
function ExtraServices({ data, handleChangeExtraService, selectedData }) {
  return (
    <div
      className="relative min-h-[194px] text-white h-fit overflow-hidden bg-primary flex flex-col p-4 gap-4 rounded-lg "
      style={{
        backgroundImage: `url('${process.env.NEXT_PUBLIC_IMAGES_URL}/banners/services.webp')`,
              ...
              >
                <div className="flex flex-row gap-2 items-center w-full">
                  <span
                    ...
                    onClick={() => {
                      handleChangeExtraService(service.slug);
                    }}
                  >
